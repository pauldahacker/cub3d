...
/*   Updated: 2024/09/28 13:00:33 by simarcha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//I named it t_grid because this is the unit that we use
//grid[x][y] is one cell of our map
...
typedef struct raycasting
{
	...
	double		angle;//angle (in degrees) of our ray starting from the abscissa axis
